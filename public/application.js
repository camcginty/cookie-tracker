...
var addCookies = function addCookies(data) {
  return $.ajax({
    method: 'POST',
...
var editCookies = function editCookies(data) {
  return $.ajax({
    method: 'PATCH',
...
var deleteCookies = function deleteCookies(data) {
  return $.ajax({
    method: 'DELETE',
    url: config.apiUrl + '/cookies/' + data.cookie.id,
    headers: {
...
var store = __webpack_require__(3);
var showCookiesTemplate = __webpack_require__(14);

var signedIn = false;

var signUpSuccess = function signUpSuccess(_signUpSuccess) {
  formResets();
  clearText();
...
var changePasswordSuccess = function changePasswordSuccess(_changePasswordSuccess) {
  formResets();
  clearText();
  $('#info').append('Password changed.');
};

var signOutSuccess = function signOutSuccess(_signOutSuccess) {
  formResets();
  clearText();
  signedIn = false;
...
var addCookiesSuccess = function addCookiesSuccess(data) {
  formResets();
  clearText();
  $('#info').append('Noted!');
};

var getCookiesSuccess = function getCookiesSuccess(data) {
  cookieTable(data);
  formResets();
  clearText();
...
var cookieTable = function cookieTable(data) {
  $('td').remove();
  var showCookiesHtml = showCookiesTemplate({ cookies: data.cookies });
  $('thead').append(showCookiesHtml);
};

var editCookiesSuccess = function editCookiesSuccess(data) {
  formResets();
  clearText();
  $('#edit-cookies').hide();
  $('#delete-cookies').hide();
...
var deleteCookiesSuccess = function deleteCookiesSuccess(data) {
  $('#edit-cookies').hide();
  $('#delete-cookies').hide();
  formResets();
  clearText();
...
var formResets = function formResets() {
  if (signedIn === true) {
...
module.exports = {
  ...
  addCookiesSuccess: addCookiesSuccess,
  getCookiesSuccess: getCookiesSuccess,
  editCookiesSuccess: editCookiesSuccess,
  deleteCookiesSuccess: deleteCookiesSuccess,
  error: error
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var authUi = __webpack_require__(5);
var store = __webpack_require__(3);
var getFormFields = __webpack_require__(8);

var onAddCookies = function onAddCookies(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.addCookies(data).then(authUi.addCookiesSuccess).then(onGetCookies).catch(authUi.error);
};

var onGetCookies = function onGetCookies() {
  // event.preventDefault()
  authApi.getCookies().then(authUi.getCookiesSuccess).catch(authUi.error);
};
...
var onEditButton = function onEditButton() {
  event.preventDefault();
  $('#edit-cookies').show();
  thisId = this.id;
...
var autoFill = function autoFill(thisId) {
...
var onEditCookies = function onEditCookies(thisId) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.editCookies(data).then(authUi.editCookiesSuccess).then(onGetCookies).catch(authUi.error);
};
...
var onDeleteCookies = function onDeleteCookies() {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.deleteCookies(data).then(authUi.deleteCookiesSuccess(data)).then(onGetCookies).catch(authUi.error);
};

module.exports = {
  onAddCookies: onAddCookies,
  onGetCookies: onGetCookies,
...
var addNestedValue = __webpack_require__(32);
...
var onSignUp = function onSignUp(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signUp(data).then(authUi.signUpSuccess).catch(authUi.error);
};

var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signIn(data).then(authUi.signInSuccess).then(events.onGetCookies).catch(authUi.error);
};

var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.changePassword(data).then(authUi.changePasswordSuccess).catch(authUi.error);
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  authApi.signOut().then(authUi.signOutSuccess).catch(authUi.error);
};
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://cookie-tracker.herokuapp.com',
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <td class=\"cookieName\">"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.cookieName : stack1), depth0))
    + " </td>\n        <td>"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.amount : stack1), depth0))
    + "</td>\n        <td>"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.distributableUnits : stack1), depth0))
    + " </td>\n        <td><button type='submit' class=\"edit-button\" id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit</button></td>\n        <td><button type=\"click\" class='delete-button' id='"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "'>Delete</button></td>\n      </tr>\n";
  ...
  return "\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.cookies : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
